            ...
            child: TextButton(
              style: TextButton.styleFrom(
                shape: RoundedRectangleBorder(
                  borderRadius: BorderRadius.circular(8.0), // 직사각형 스타일 적용
                  // side: BorderSide(
                  //   color: isSelectedDay
              ...
              child: Column(
                ...
                children: [
                  if (isSelectedDay) // 선택되었을 때 아래 정사각형 추가
                    Container(
                      width: 16,
                      height: 16,
                      margin: EdgeInsets.only(top: 4.0),
                      decoration: BoxDecoration(
                        color: widget.selectedDayButtonColor,
          ...
          Positioned(
            child: Container(
              ...
              child: GridView.count(
                ...
                childAspectRatio: 0.7, // 세로가 더 길어지도록 변경
